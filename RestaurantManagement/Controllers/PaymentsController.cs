...
namespace RestaurantManagement.Controllers
{
    ...
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CustomerName,PaymentMethod,Amount")] Payments payments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerName,PaymentMethod,Amount")] Payments payments)
        {
            if (id != payments.Id)
            {
                return NotFound();
